...
public class AutenticacaoIntegTest {

    @Autowired
    WebTestClient testClient;

    @Test
    public void autenticar_ComCredenciaisValidas_RetornoTokenComStatus200() {
    ...
    @Test
    public void autenticar_ComCredenciaisInvalidas_RetornoErrorMessageComStatus400() {
        ...
        responseBody = testClient
            ...
            .uri("/api/v1/auth")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(new UsuarioLoginDto("ana@email.com", "654321"))
    ...
    @Test
    public void autenticar_ComUsernameFormatoInvalido_RetornoErrorMessageComStatus422() {
        ErrorMessage responseBody = testClient
            .post()
            .uri("/api/v1/auth")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void autenticar_ComPasswordFormatoInvalido_RetornoErrorMessageComStatus422() {
        ErrorMessage responseBody = testClient
            .post()
            .uri("/api/v1/auth")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(new UsuarioLoginDto("ana@email.com", "1234"))
