...
public class ClienteIntegTest {
   ...
   @Autowired
    ...
    public void buscarClientes_ComDadosDoTokenDeCliente_RetornarClienteComStatus200() {
        ...
        //Teste de confirmação se a requisição esta retornando o que se espera.
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();   
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("58381645069");
        org.assertj.core.api.Assertions.assertThat(responseBody.getNome()).isEqualTo("Bianca Silva"); 
        org.assertj.core.api.Assertions.assertThat(responseBody.getId()).isEqualTo(10); 
    }

    @Test
    public void buscarClientes_ComDadosDoTokenDeAdministrador_RetornarErroMessageComStatus403() {
        ErrorMessage responseBody = testClient  
                    .get()
                    .uri("/api/v1/clientes/detalhes")
